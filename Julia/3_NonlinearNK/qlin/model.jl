...
function pf(fc0,fp0,rnpast,znow,rnow,tau,kappa,psi1,psi2,rho_R,rho_z,bet)

    invtau = 1/tau
    c0 = fc0 + invtau*(1-(1-rho_R)*psi1*bet)*fp0 - invtau*rho_R*rnpast + invtau*rho_z*znow - invtau*rnow
    c0 = c0/(1+invtau*(1-rho_R)*(kappa*psi1+psi2))
    pi0 = kappa*c0 + bet*fp0
